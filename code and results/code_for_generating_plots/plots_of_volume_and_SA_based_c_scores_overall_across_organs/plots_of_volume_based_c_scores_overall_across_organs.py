...
plt.title("Volume-based C score distributions across organs")
...
plt.tight_layout()
plt.savefig("volume_based_c_score_distributions_overall_across_organs_with_outliers.png", dpi=300, bbox_inches="tight")
plt.show()