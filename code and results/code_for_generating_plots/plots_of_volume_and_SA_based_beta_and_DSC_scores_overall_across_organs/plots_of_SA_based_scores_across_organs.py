...
# ---------------------------
CSV_IN  = Path("Volume and surface scores for selected organs - test_with_organ_zscores_and_with_overall_non_organ_specific_z_scores.csv")
...
plt.title("SA-based scores across organs")
...
plt.tight_layout()
plt.savefig("SA_based_scores_overall_across_organs_without_outliers.png", dpi=300, bbox_inches="tight")
plt.show()