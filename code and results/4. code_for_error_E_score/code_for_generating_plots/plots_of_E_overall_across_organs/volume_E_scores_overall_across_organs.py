...
df_long = df_.melt(
        ...
        value_vars=['volume_E_lambda_0.00', 'volume_E_lambda_0.25', 'volume_E_lambda_0.50', 'volume_E_lambda_0.75', 'volume_E_lambda_1.00'],  # scores --> hue
        var_name="Score type",
...
# x_order = ['volume_E_lambda_0.00', 'volume_E_lambda_0.25', 'volume_E_lambda_0.50', 'volume_E_lambda_0.75', 'volume_E_lambda_1.00']
...
plt.title(f"volume-based $Error$ $(E)$ across organs $(n={no_of_patients})$")
...
plt.tight_layout()
plt.savefig("volume_based_E_with_outliers.png", dpi=300, bbox_inches="tight")
plt.show()