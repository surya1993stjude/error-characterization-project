...
# ---------------------------
CSV_IN  = Path("C:\\Users\\ssarka62\\Documents\\GitHub\\error_characterization_project\\code and results\\4. code_for_error_E_score\\computing_E_scores\\computing_surface_E\\output_file(s)\\surface_E.csv")
...
df_long = df_.melt(
        ...
        value_vars=['surface_E_lambda_0.00', 'surface_E_lambda_0.25', 'surface_E_lambda_0.50', 'surface_E_lambda_0.75', 'surface_E_lambda_1.00'],  # scores --> hue
        var_name="Score type",
...
# x_order = ['surface_E_lambda_0.00', 'surface_E_lambda_0.25', 'surface_E_lambda_0.50', 'surface_E_lambda_0.75', 'surface_E_lambda_1.00']
...
plt.title(f"SA-based $Error$ $(E)$ across organs $(n={no_of_patients})$")
...
plt.tight_layout()
plt.savefig("SA_based_E_without_outliers.png", dpi=300, bbox_inches="tight")
plt.show()