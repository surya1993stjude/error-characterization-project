...
for organ_name in organs_list:
    ...
    counts = (
    df_plot.groupby("interpretation_surface")
    .size()
    ...
    plt.title(f"SA-based $\\tau$ scores for {organ_name}")
    ...
    plt.tight_layout()
    plt.savefig(f"{organ_name}_SA_tow_without_outliers.png", dpi=300, bbox_inches="tight")
    plt.show()