...
# x_order = ['tow_volume_lambda_0.00', 'tow_volume_lambda_0.25', 'tow_volume_lambda_0.50', 'tow_volume_lambda_0.75', 'tow_volume_lambda_1.00']
...
plt.title(f"Volume-based $\\tau$ score distributions across organs $(n={no_of_patients})$")
...
plt.tight_layout()
plt.savefig("volume_based_without_outliers.png", dpi=300, bbox_inches="tight")
plt.show()