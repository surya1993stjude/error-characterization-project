...
# ---------------------------
CSV_IN  = Path("C:\\Users\\ssarka62\\Documents\\GitHub\\error_characterization_project\\code and results\\3. code_for_tow_based_results\\computing_tow_scores\\computing_surface_tow\\output_file(s)\\Volume_and_surface_scores_with_C_scores_with_rounded_columns_and_tow_surface.csv")
...
df_long = df_.melt(
        ...
        value_vars=['tow_surface_lambda_0.00', 'tow_surface_lambda_0.25', 'tow_surface_lambda_0.50', 'tow_surface_lambda_0.75', 'tow_surface_lambda_1.00'],  # scores --> hue
        var_name="Score type",
...
# x_order = ['tow_surface_lambda_0.00', 'tow_surface_lambda_0.25', 'tow_surface_lambda_0.50', 'tow_surface_lambda_0.75', 'tow_surface_lambda_1.00']
...
plt.title(f"SA-based $\\tau$ score distributions across organs $(n={no_of_patients})$")
...
plt.tight_layout()
plt.savefig("SA_based_tow_score_distributions_overall_across_organs_with_outliers.png", dpi=300, bbox_inches="tight")
plt.show()