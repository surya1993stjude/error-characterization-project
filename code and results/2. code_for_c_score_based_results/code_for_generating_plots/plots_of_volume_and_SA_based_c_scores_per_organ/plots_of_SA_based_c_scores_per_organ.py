...
for organ_name in organs_list:
    ...
    df_long = df_.melt(
        ...
        value_vars=["C_surface_lambda_0", "C_surface_lambda_0.25", "C_surface_lambda_0.5", "C_surface_lambda_0.75", "C_surface_lambda_1.0"],  # scores become hue groups
        var_name="Score type",
    ...
    plt.tight_layout()
    plt.savefig(f"{organ_name}_surface_based_C_scores_with_outliers.png", dpi=300, bbox_inches="tight")
    plt.show()