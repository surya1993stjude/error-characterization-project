...
df_long = df_.melt(
        ...
        value_vars=['C_volume_lambda_0', 'C_volume_lambda_0.25', 'C_volume_lambda_0.5', 'C_volume_lambda_0.75', 'C_volume_lambda_1.0'],  # scores --> hue
        var_name="Score type",
...
# x_order = ['C_volume_lambda_0', 'C_volume_lambda_0.25', 'C_volume_lambda_0.5', 'C_volume_lambda_0.75', 'C_volume_lambda_1.0']
...
plt.title(f"Volume-based C score distributions across organs $(n={no_of_patients})$")
...
plt.tight_layout()
plt.savefig("volume_based_with_outliers.png", dpi=300, bbox_inches="tight")
plt.show()